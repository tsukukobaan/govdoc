"""Scraper for Ministry of Defense (防衛省) advisory councils."""
...
class MODScraper(BaseScraper):
    ministry_slug = "mod"
    INDEX_URL = "https://www.mod.go.jp/j/policy/agenda/meeting/index.html"
    request_interval = 5.0  # Slower to avoid 403
    use_playwright = True
    ...
    def scrape(self) -> list[dict]:
        ...
        print("  Fetching MOD meeting master index...")
        try:
